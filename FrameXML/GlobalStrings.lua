...
HELPFRAME_REPORT_BUG_TEXT1 = "TEMPORARY TEXT";
...
HELPFRAME_REPORT_PLAYER_TEXT1 = "TEMPORARY TEXT";
...
HELPFRAME_SUBMIT_SUGGESTION_TEXT1 = "TEMPORARY TEXT";
...
REPORT_CHEATING_EDITBOX_INFO = "Type your description here.";
REPORT_CHEATING_TEXT1 = "Describe in detail what you saw and how you feel it was cheating. Providing more details will make it easier for us to take action.";
...
REPORT_PLAYER_NAME_TEXT1 = "You can report someone for having a bad player name, guild name, or arena team name.";
